describe("Product page", () => {
  ...
  it("Product with all quantities", () => {
    ...
    for (let i = 2; i <= 9; i++) {
      cy.log(`Check ${i} products with ${i * 20} price`);
  ...
  it("Check links on Product page", () => {
    ...
    cy.fixture("Payment_Gateway/links").then((links) => {
      for (let [elementName, pageLink] of Object.entries(links)) {
        cy.log(`Check ${elementName} link with ${pageLink} url`);
